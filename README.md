# portable_vim
Versión portable y personalizada de Vim (Vi Improved 9.1 Normal version without GUI) para Linux ya testeado en Ubuntu (20.04, 22.04, 24.04) en los ordenadores de prácticas de la ETSIIT UGR. Contamina el $HOME. Asume uso de bash
